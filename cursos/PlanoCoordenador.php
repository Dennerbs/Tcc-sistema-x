          ...
          <form method="POST" action="PlanoComentarios.php">
                ...
                <form method="POST" action="PlanoEvolucao.php">
                  ...
                  <div class="form-group">
                    <button type="submit" class="btn btn-success mt-4 inline-block">Finalizar</button>
                    <small id="notificacao" class="form-text text-muted">Tudo ok com o plano? Está na hora de finalizá-lo</small>
                  </div>                 
                </form>
              </div>
            </div>
